...
package com.video.youtuberplayer.model.videostream;
...
public class ParseStreamMetaData {
  ...
  public String init(String videoId) throws Exception {
    ...
    if (decryptionCode.isEmpty()) {
      try {
        ...
        return VideoPlayerApplication.getStr(R.string.error_stream_decryption_fail);
      }
    }
  ...
  private String getJplayerJsonErrorMessage(String pageContent) {
    ...
    try {
      ...
      errorMessage = new StringBuilder(VideoPlayerApplication.getStr(R.string.error_stream_err_unavailable));
    }
