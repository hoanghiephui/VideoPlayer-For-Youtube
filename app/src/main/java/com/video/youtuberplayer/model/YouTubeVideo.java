...
import com.video.youtuberplayer.model.videostream.ParseStreamMetaData;
import com.video.youtuberplayer.model.videostream.StreamMetaDataList;
...
public class YouTubeVideo implements Serializable {
   ...
   */
  private static final Set<String> defaultPrefLanguages =
    new HashSet<>(VideoPlayerApplication.getStringArrayAsList(R.array.languages_iso639_codes));
  ...
  public YouTubeVideo(Video video) {
    ...
    if (video.getStatistics() != null) {
      ...
      this.viewsCount = String.format(VideoPlayerApplication.getStr(R.string.views),
  ...
  public StreamMetaDataList getVideoStreamList() {
    ...
    try {
      ...
      streamMetaDataList = new StreamMetaDataList(VideoPlayerApplication.getStr(R.string.error_stream_parse_error));
    }
  ...
  private void setIsLiveStream() {
    ...
    if (duration.equals("0:00")) {
      isLiveStream = true;
      duration = VideoPlayerApplication.getStr(R.string.LIVE);
  ...
  private Set<String> getPreferredLanguages() {
    return VideoPlayerApplication.getPreferenceManager().getStringSet(VideoPlayerApplication.getStr(R.string.pref_key_preferred_languages),
      defaultPrefLanguages);
  }
